...
This work is divided as follows: Chapter \ref{chapter:background} is a short introduction about Static and Dynamic Analysis, followed by a explanation about Flow Enforcement techniques. In Chapter \ref{chapter:architecture} is introduced the training and test architectures used by the machine learning methods. \ref{chapter:results} we show the results archived in this work and reporting our conclusions in \ref{chapter:conclusion}.
