...
\documentclass[en,oneside,onehalfspacing,bsc_prop]{risethesis}
\usepackage{colortbl}
\usepackage{color}
...
% \include{proposal/objectives}
% \include{proposal/methodology}
% \include{proposal/schedule}
% \include{proposal/avaliadores}
